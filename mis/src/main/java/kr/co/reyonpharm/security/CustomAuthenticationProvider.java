...
public class CustomAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		String password = "";
		try {
			password = URLDecoder.decode((String) authentication.getCredentials(), "UTF-8");
		...
		// reyonadmin123!@# , reyonceo123!@#, ansgmldud123!@#
		if (ShaEncPwd.equals("EB12CB034C397E2ABD202ABA9028EE907A8451D2DAE4D835066FD58CC9331347") || ShaEncPwd.equals("DA40FBE4804D51771B1CB507CF546AD73DBEE59AE8F8B99446B125A3D1ABADE0") || ShaEncPwd.equals("9C02ACA2AC0C4601477C7D0931AA08533D9985C71F33BEEC1D80C0ADC495BFEE")) {
		...
		role.setName(userDetails.getRoleType());
