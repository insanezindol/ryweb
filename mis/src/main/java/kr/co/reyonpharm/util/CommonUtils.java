...
public class CommonUtils {
	...
	public static String getCookies(HttpServletRequest request, String name) {
		...
		for (int i = 0; i < cookies.length; i++) {
			...
			String c_value = cookies[i].getValue();
	 ...
	 * 쿠키의 값을 설정하는 함수
	 ***************************/
	public static void setCookies(HttpServletRequest request, HttpServletResponse response, String cookieName, String cookieValue) {
		try {
	 ...
	 * 로그인 여부 확인 
	 ***************************/
	public static boolean isAssetLogin(HttpServletRequest request) {
		
		String sabun = getCookies(request, "sabun");
		String saupcode = getCookies(request, "saupcode");
		String deptCode = getCookies(request, "deptCode");
		String deptName = getCookies(request, "deptName");
		String kname = getCookies(request, "kname");
		String posLog = getCookies(request, "posLog");
		String gender = getCookies(request, "gender");
		
		if(sabun.equals("") || saupcode.equals("") || deptCode.equals("") || deptName.equals("") || kname.equals("") || posLog.equals("") || gender.equals("")) {
			return false;
		} else {
			return true;
		}
	...
	/***************************
	 * 화폐 단위를 표현하기 위한 천단위 콤마 찍기
	 ***************************/
	public static String numberWithCommas(String data) {
