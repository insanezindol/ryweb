...
/**************************************************************************
 * LNB 영역 메뉴의 정보를 로그인 정보에 맞게 설정
 * 
 * @param 
***************************************************************************/
function cfSetLnbInfo(){
	var deptName = getCookieByDecodeURI("deptName");
	var kname = getCookieByDecodeURI("kname");
	var posLog = getCookieByDecodeURI("posLog");
	var gender = getCookieByDecodeURI("gender");
	$("#sidebar_img").attr("src","/images/user"+gender+".png");
	$("#sidebar_name").text(kname + " " + posLog);
	$("#sidebar_dept").text(deptName);
}
 ...
 * @returns String              : 쿠키 값
****************************************************************/
function getCookieByDecodeURI(cookieName) {
	cookieName = cookieName + '=';
	var cookieData = document.cookie;
	var start = cookieData.indexOf(cookieName);
	var cookieValue = '';
 ...
 * @returns 일수
****************************************************************/
function cfCalcDate(startDate, endDate) {
	var startDateArray = startDate.split("-");
	var endDateArray = endDate.split("-");
    var date1 = new Date(startDateArray[0], Number(startDateArray[1])-1, startDateArray[2]);
	var date2 = new Date(endDateArray[0], Number(endDateArray[1])-1, endDateArray[2]);
    var count = 0;
	while(true) {
	    var temp_date = date1;
 ...
 * @returns 일수
****************************************************************/
function cfCalcTime(startTime, endTime) {
	// 시작일시 
	var date1 = new Date(parseInt(startTime.substring(0,4), 10),
			...
			parseInt("00", 10) );
   // 종료일시 
	var date2 = new Date(parseInt(endTime.substring(0,4), 10),
			...
			parseInt("00", 10) );
	var dateGap = date2.getTime() - date1.getTime();
 ...
 * 
 * @param date 특정시간
 * @param minutes 더하기 할 분
 * 
 * @returns 더하기 완료된 시간
****************************************************************/
function cfAddMinutes(date, minutes) {
