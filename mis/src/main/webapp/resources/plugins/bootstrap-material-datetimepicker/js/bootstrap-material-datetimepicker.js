(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'en', weekStart: 0, shortTime: false, clearButton: false, nowButton: false, cancelText: '취소', okText: '확인', clearText: 'Clear', nowText: 'Now', switchOnClick: false, minuteStep : 5};
   ...
   Plugin.prototype =
           {
              ...
              _onSelectHour: function (e)
              {
                 if (!$(e.target).hasClass('disabled'))
                 {
                    ...
                    {
                       var fillColor = $(th[i]).attr('fill');
                       if(fillColor == '#bdbdbd'){
                    	   $(th[i]).attr('fill', '#bdbdbd');
                       } else if(fillColor == '#fff' || fillColor == '#000'){
                    	   $(th[i]).attr('fill', '#000');
                       }
                    }
