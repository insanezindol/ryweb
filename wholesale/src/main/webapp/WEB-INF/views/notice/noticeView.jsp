...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function modifyInfo(){
				var seq = $("#seq").val();
				var url = "/notice/noticeModify.do?seq=" + seq;
			...
			function deleteInfo(){
				...
				if(confirm("삭제 하시겠습니까?")){
					...
					var request = $.ajax({
						url: '/notice/noticeDeleteAjax.json'
						, type : 'POST'
						, timeout: 30000
						, data : params
						, dataType : 'json'
			...
			<section id="main-content">
				...
				<section class="wrapper">
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-file-text-o"></i> 공지사항 상세
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>도매관리</li>
								<li><i class="fa fa-book"></i>공지사항</li>
								<li><i class="fa fa-file-text-o"></i>공지사항 상세</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
								...
								<div class="panel-body">
									<form class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<p class="form-control-static">${info.contents }</p>
											</div>
										</div>
										<div class="form-group">
					...
					<div class="btn-row text-right">
						...
						<c:if test="${principalUserRole == 'ROLE_ADMIN' || principalUserRole == 'ROLE_SUPERUSER' }">
