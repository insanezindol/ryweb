...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			// 페이지 이동
			function goUrl(){
				location.href="/admin/loginLogList.do?pageNo="+pageParam.pageNo+"&pageSize="+pageParam.pageSize+"&username="+encodeURIComponent(pageParam.username, "UTF-8")+"&ip="+encodeURIComponent(pageParam.ip, "UTF-8");
			}
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-list"></i> 접속 로그 목록
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>도매관리</li>
								<li><i class="fa fa-cog"></i>관리자</li>
								<li><i class="fa fa-history"></i>접속 로그 관리</li>
								<li><i class="fa fa-list"></i>접속 로그 목록</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
							...
							<section class="panel">
								...
								<div class="panel-body collapse" id="searchPanel">
									<form class="form-horizontal">
										...
										<div class="form-group">
											<label class="col-lg-2 control-label">접속 IP</label>
											<div class="col-lg-8">
												<input type="text" id="ip" class="form-control" maxlength="20">
											</div>
											<div class="col-lg-2">
								...
								<table class="table table-bordered">
									...
									<thead>
										<tr>
											...
											<th class="text-center">로그인 일시</th>
											<th class="text-center">로그아웃 일시</th>
										</tr>
									</thead>
									<tbody>
										<c:choose>
											...
											<c:otherwise>
												<c:forEach var="result" items="${list}" varStatus="status">
													<tr>
														...
														<td class="text-center">${result.loginDate }</td>
														<td class="text-center">${result.logoutDate }</td>
													</tr>
												</c:forEach>
											</c:otherwise>
										</c:choose>
