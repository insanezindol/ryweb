...
<script type="text/javascript">
	...
	function goCompany() {
		var win = window.open("http://www.reyonpharm.co.kr/", "_blank");
		win.focus();
	}
	...
	<div class="container">
		...
		<form class="login-form">
			<div class="login-wrap">
				...
				<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-user"></i></span> <input type="text" id="userId" class="form-control" placeholder="사업자 번호" maxlength="10" autofocus>
				</div>
				<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-key"></i></span> <input type="password" id="userPwd" class="form-control" placeholder="비밀번호">
				</div>
				<label class="checkbox"> 
					<input type="checkbox" id="idSaveCheck"> 사업자 번호 기억하기
				</label>
		...
		<div class="text-right">
			<div class="credits" style="margin-top: 20px;">
				<a href="javascript:;" onClick="javascript:goCompany();" style="color: #fff;">ⓒ REYON PHARMACEUTICAL CO LTD</a>
			</div>
			<div class="credits" style="color: #fff;">
				이연제약 도매관리 시스템은 Internet Explorer10 이상 또는 Chrome에서 최적화된 서비스 이용이 가능합니다.
			</div>
		</div>
