	...
	<body>
		...
		<section id="container" class="">
			...
			<header class="header header-bg">
				...
				<!--logo start-->
				<a href="/main.do" class="logo">이연제약 관리 시스템</a>
				<!--logo end-->
			</header>
			<!-- header end -->
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<p>에러 코드 : ${resultCode}</p>
									<p>에러 메시지 : ${resultMsg}</p>
									<div class="btn-row">
										<a class="btn btn-default" href="javascript:;" title="확인" style="margin-top: 7px;" onClick="javascript:goPage();"><span class="icon_check"></span>&nbsp;확인</a>
									</div>
								</div>
							</div>
						</div>
