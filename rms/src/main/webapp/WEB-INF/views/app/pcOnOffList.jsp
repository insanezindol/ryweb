...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			// 페이지 이동
			function goUrl(){
				location.href="/app/pcOnOffList.do?pageNo="+pageParam.pageNo+"&pageSize="+pageParam.pageSize+"&s_sabun="+encodeURIComponent(pageParam.s_sabun, "UTF-8")+"&s_regName="+encodeURIComponent(pageParam.s_regName, "UTF-8")+"&s_ip="+encodeURIComponent(pageParam.s_ip, "UTF-8")+"&startDate="+encodeURIComponent(pageParam.startDate, "UTF-8");
			}
		</script>
	</head>
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-list"></i> PC ON/OFF 보고 목록
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>관리 시스템</li>
								<li><i class="fa fa-desktop"></i>PC 관리</li>
								<li><i class="fa fa-list"></i>PC ON/OFF 보고 목록</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
								...
								<div class="panel-body collapse" id="searchPanel">
									<form class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input type="text" id="s_ip" class="form-control" maxlength="50">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 control-label">일자</label>
											<div class="col-lg-8">
								...
								<table class="table table-bordered">
									...
									<thead>
										<tr>
											...
											<th class="text-center">최초 보고 시간</th>
											<th class="text-center">마지막 보고 시간</th>
										</tr>
									</thead>
									<tbody>
										<c:choose>
											...
											<c:otherwise>
												<c:forEach var="result" items="${list}" varStatus="status">
													<tr>
														...
														<td class="text-center">${result.ip }</td>
														<td class="text-center">${result.reportFirstDate }</td>
														<td class="text-center">${result.reportLastDate }</td>
													</tr>
												</c:forEach>
											</c:otherwise>
										</c:choose>
