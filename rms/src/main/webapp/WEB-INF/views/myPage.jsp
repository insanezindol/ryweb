			...
			<section id="main-content">
				...
				<section class="wrapper">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<ol class="breadcrumb">
								...
								<li><i class="fa fa-user"></i>내 정보</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
								...
								<div class="panel-body">
									<form class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<p class="form-control-static"><sec:authentication property="principal.posLog" /></p>
											</div>
										</div>
										<div class="form-group">
					...
					<div class="btn-row text-right">
						<a class="btn btn-default" href="javascript:;" title="확인하기" style="margin-top: 7px;" onClick="javascript:goMain();"><span class="icon_check"></span>&nbsp;확인</a>
					</div>
					<!-- bottom button end -->
