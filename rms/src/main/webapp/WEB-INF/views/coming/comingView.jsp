...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			// 수정
			function modifyComing(){
				var seq = $("#seq").val();
				var url = "/coming/comingModify.do?visitSeq=" + seq;
			...
			function deleteComing(){
				...
				if(confirm("삭제 하시겠습니까?")){
					...
					var request = $.ajax({
						url: '/coming/comingDeleteAjax.json'
						, type : 'POST'
						, timeout: 30000
						, data : params
						, dataType : 'json'
			...
			<section id="main-content">
				...
				<section class="wrapper">
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-file-text-o"></i> 출입자 상세
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>관리 시스템</li>
								<li><i class="fa fa-address-card-o"></i>출입자 관리</li>
								<li><i class="fa fa-file-text-o"></i>출입자 상세</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
								...
								<div class="panel-body">
									<form class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<p class="form-control-static">${info.visitStartDate }</p>
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 control-label">접견인</label>
											<div class="col-lg-10">
												<p class="form-control-static">${info.meetDeptName } ${info.meetName }</p>
											</div>
										</div>
										<div class="form-group">
					...
					<div class="btn-row text-right">
						...
						<c:if test="${isMine }">
						<a class="btn btn-default" href="javascript:;" title="수정하기" style="margin-top: 7px;" onClick="javascript:modifyComing();"><span class="icon_pencil-edit"></span>&nbsp;수정</a>
						<a class="btn btn-default" href="javascript:;" title="삭제하기" style="margin-top: 7px;" onClick="javascript:deleteComing();"><span class="icon_trash"></span>&nbsp;삭제</a>
						</c:if>
