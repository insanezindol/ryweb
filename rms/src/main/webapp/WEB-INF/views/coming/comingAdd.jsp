					...
					var request = $.ajax({
						...
						, success : function(json) {
							if (json.resultCode == 1){
								alert("저장 완료 되었습니다.");
								location.href="/coming/comingList.do";
							}else if (json.resultCode == 1201) {
								alert(json.resultMsg);
								cfLogin();
							}else{
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-pencil"></i> 출입자 등록
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>관리 시스템</li>
								<li><i class="fa fa-address-card-o"></i>출입자 관리</li>
								<li><i class="fa fa-pencil"></i>출입자 등록</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
								...
								<div class="panel-body">
									<form class="form-horizontal">
												...
												<div class="row">
													<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
														<div class="input-group date" id="visitStartDatePicker">
										                    <input type="text" id="visitStartDate" class="form-control" />
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" id="meetPerson" class="form-control" maxlength="10">
												<table class="table table-bordered table-hover personal-task" id="meetPersonTable" style="display:none;">
													<colgroup>
														<col style="width:35%" />
														<col style="width:35%" />
														<col style="width:30%" />
													...
													<tbody id="meetPersonTbody">
														<tr id="meetPersonTr0"><td colspan="3">접견인을 추가해 주세요.<input type="hidden" id="meetDeptCode" value="" ><input type="hidden" id="meetDeptName" value="" ><input type="hidden" id="meetSabun" value="" ><input type="hidden" id="meetName" value="" ></td></tr>
													</tbody>
												</table>
											</div>
										</div>
