	...
	<head>
		...
		<script type="text/javascript">
			$(function() {
				...
				$("#emrg").val("${info.emrg}").prop("selected", true);
				$("#startDate").val("${info.sdate}");
				$("#endDate").val("${info.edate}");
			});
			...
			function goConfirm() {
				...
				if(confirm("등록하시겠습니까?")){
					...
					var request = $.ajax({
						url: '/production/productionModifyAjax.json'
						, type : 'POST'
						, timeout: 30000
						, data : params
						, dataType : 'json'
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-list"></i> 진천공장 알림 수정
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>관리 시스템</li>
								<li><i class="fa fa-bell-o"></i>진천공장 알림 관리</li>
								<li><i class="fa fa-pencil-square-o"></i>진천공장 알림 수정</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
