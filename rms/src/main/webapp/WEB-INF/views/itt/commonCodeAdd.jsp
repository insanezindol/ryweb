	...
	<head>
		...
		function goConfirm() {
			...
			if(confirm("등록하시겠습니까?")){
				...
				var request = $.ajax({
					url: '/itt/commonCodeAddAjax.json'
					, type : 'POST'
					, timeout: 30000
					, data : params
					, dataType : 'json'
					...
					, success : function(json) {
						if (json.resultCode == 1){
							alert("저장 완료 되었습니다.");
							location.href = "/itt/commonCodeList.do";
								...
								<div class="panel-body">
									<form class="form-horizontal">
										<div class="form-group">
											<label class="col-lg-2 control-label">그룹코드 <span style="color: red;">(필수)</span></label>
											<div class="col-lg-10">
												<input type="text" id="grpCode" class="form-control" maxlength="50" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 control-label">코드 <span style="color: red;">(필수)</span></label>
											<div class="col-lg-10">
												<input type="text" id="code" class="form-control" maxlength="50" />
											</div>
										</div>
										<div class="form-group">
