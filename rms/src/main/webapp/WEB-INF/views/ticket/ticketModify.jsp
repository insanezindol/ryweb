	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				// 담당 부서 기본 설정
				$("#refDeptCode").val("${info.refDeptCode}").prop("selected", true);
				
				// 지급구분 기본 설정
				$("#isWebSale").val("${info.isWebSale}").prop("selected", true);
				...
				// set default value
				$("#countHour2").val("${info.countHour2 }");
				$("#countHour3").val("${info.countHour3 }");
				$("#countHour4").val("${info.countHour4 }");
				$("#countHour6").val("${info.countHour6 }");
				$("#countHour24").val("${info.countHour24 }");
				$("#webSalePrice").val("${info.webSalePrice }");
			});
			...
			function goConfirm() {
				...
				if(confirm("수정하시겠습니까?")){
					...
					var request = $.ajax({
						url: '/ticket/ticketModifyAjax.json'
						, type : 'POST'
						, timeout: 30000
						, data : params
						, dataType : 'json'
						...
						, success : function(json) {
							if (json.resultCode == 1){
								alert("저장 완료 되었습니다.");
								var url = "/ticket/ticketView.do?parkingSeq="+parkingSeq;
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-pencil-square-o"></i> 주차권 지급 수정
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>관리 시스템</li>
								<li><i class="fa fa-car"></i>주차권 관리</li>
								<li><i class="fa fa-pencil-square-o"></i>주차권 지급 수정</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
								...
								<div class="panel-body">
									<form class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="hidden" id="visitSeq" value="${info.visitSeq }" />
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" id="visitPurpose" class="form-control" maxlength="50" value="${info.visitPurpose }" >
											</div>
										</div>
										<div class="form-group">
															...
															<tbody>
																	...
																	<td class="text-center">
																		<div class="input-group">
																			<span class="input-group-btn">
																				<button type="button" class="btn btn-default btn-number" data-type="minus" data-field="quant[1]" style="padding: 9px 12px;">
																...
																<tr>
																	...
																	<td class="text-center">
																		<div class="input-group">
																			<span class="input-group-btn">
																				<button type="button" class="btn btn-default btn-number" data-type="minus" data-field="quant[2]" style="padding: 9px 12px;">
																					<span class="glyphicon glyphicon-minus"></span>
																				</button>
																...
																<tr>
																	...
																	<td class="text-center">
																		<div class="input-group">
																			<span class="input-group-btn">
																				<button type="button" class="btn btn-default btn-number" data-type="minus" data-field="quant[3]" style="padding: 9px 12px;">
																					<span class="glyphicon glyphicon-minus"></span>
																				</button>
																...
																<tr>
																	...
																	<td class="text-center">
																		<div class="input-group">
																			<span class="input-group-btn">
																				<button type="button" class="btn btn-default btn-number" data-type="minus" data-field="quant[4]" style="padding: 9px 12px;" disabled>
																					<span class="glyphicon glyphicon-minus"></span>
																				</button>
																...
																<tr>
																	...
																	<td class="text-center">
																		<div class="input-group">
																			<span class="input-group-btn">
																				<button type="button" class="btn btn-default btn-number" data-type="minus" data-field="quant[7]" style="padding: 9px 12px;">
																					<span class="glyphicon glyphicon-minus"></span>
																				</button>
														...
														<table class="table table-bordered">
															<tbody>
																...
																<tr>
																	...
																	<td class="text-center">
																		<input type="number" name="webSalePrice" id="webSalePrice" class="form-control">
																	</td>
																</tr>
															</tbody>
														</table>
										...
										<c:choose>
											<c:when test="${isGeneralMagager }">
										<div class="form-group">
											<label class="col-lg-2 control-label">지급일시</label>
											<div class="col-lg-10">
												<div class="row">
													<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
														<div class="input-group date" id="giveDatetime">
										                    <input type="text" id="giveDate" class="form-control" value="${info.giveDate }" />
