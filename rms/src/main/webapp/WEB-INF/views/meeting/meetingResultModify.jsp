		...
		<script type="text/javascript">
			...
			function goConfirm() {
				...
				if(confirm("수정하시겠습니까?")){
					...
					var request = $.ajax({
						url: '/meeting/meetingResultModifyAjax.json'
						, type : 'POST'
						, timeout: 0
						, data : formData
						, processData : false
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-pencil-square-o"></i> 회의 결과 수정
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>관리 시스템</li>
								<li><i class="fa fa-calendar"></i>회의 관리</li>
								<li><i class="fa fa-file-text-o"></i>회의 상세</li>
								<li><i class="fa fa-pencil-square-o"></i>회의 결과 수정</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
						...
						<div class="col-lg-12">
							<section class="panel" style="margin-bottom: 5px;">
								...
								<div class="panel-body">
									<form class="form-horizontal">
										<div class="form-group">
											<label class="col-lg-2 control-label">회의내용<br><span id="byteInfo1">0</span>/4000Byte</label>
											<div class="col-lg-10">
