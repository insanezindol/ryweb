		...
		<script type="text/javascript">
			...
			function goConfirm() {
				...
				if(confirm("수정하시겠습니까?")){
					...
					var request = $.ajax({
						url: '/project/projectModifyAjax.json'
						, type : 'POST'
						, timeout: 30000
						, data : params
						, dataType : 'json'
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-pencil-square-o"></i> 프로젝트 수정
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>관리 시스템</li>
								<li><i class="fa fa-briefcase"></i>프로젝트 관리</li>
								<li><i class="fa fa-pencil-square-o"></i>프로젝트 수정</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
								...
								<div class="panel-body">
									<form class="form-horizontal">
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" id="projectName" class="form-control" maxlength="50" value="${info.projectName}">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-lg-5">
												<div class="input-group date" id="projectStartDatePicker">
								                    <input type="text" id="projectStartDate" class="form-control" placeholder="프로젝트 시작일" value="${info.projectStartDate}" />
											...
											<div class="col-lg-5">
												<div class="input-group date" id="projectEndDatePicker">
								                    <input type="text" id="projectEndDate" class="form-control" placeholder="프로젝트 종료일" value="${info.projectEndDate}" />
								                    <span class="input-group-addon">
								                        <span class="glyphicon glyphicon-calendar"></span>
								                    </span>
								                </div>
													...
													<tbody id="attendee1Tbody">
														<c:choose>
															<c:when test="${fn:length(attList1) == 0}">
																<tr id="attendee1Tr0"><td colspan="3">참여자를 추가해 주세요.</td></tr>
															</c:when>
															<c:otherwise>
