		...
		<script type="text/javascript">
			...
			function goConfirm() {
				...
				if(confirm("등록하시겠습니까?")){
					...
					var request = $.ajax({
						url: '/visitor/visitorAddAjax.json'
						, type : 'POST'
						, timeout: 30000
						, data : params
						, dataType : 'json'
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-pencil"></i> 방문자 등록
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>관리 시스템</li>
								<li><i class="fa fa-address-card-o"></i>방문자 관리</li>
								<li><i class="fa fa-pencil"></i>방문자 등록</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
							...
							<section class="panel">
								...
								<div class="panel-body">
									<form class="form-horizontal">
										...
										<div class="form-group">
											<label class="col-lg-2 control-label">방문일시 <span class="glyphicon glyphicon-info-sign icon_info" title="방문 날짜와 시간을 선택하고 조회를 클릭합니다. 하단 장소 표에 예약가능한 장소가 초록색 박스로 나타면 선택합니다."></span></label>
											<div class="col-lg-3">
												<div class="input-group date" id="meetingDatePicker">
								                    <input type="text" id="meetingDate" class="form-control" placeholder="방문날짜" />
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<div class="checkbox">
													<label><input type="checkbox" id="confirmType">별도의 방문 결과가 없는 경우 선택 (방문결과등록, 결재 없음) <span class="glyphicon glyphicon-info-sign icon_info" title="회의를 대신 등록하거나 별도의 방문 결과가 없는 경우 체크합니다."></span></label>
												</div>
											</div>
										</div>
										<div class="form-group">
		...
		<div aria-hidden="true" aria-labelledby="descModalLabel" role="dialog" tabindex="-1" id="descModal" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
						<h4 class="modal-title">방문자 등록 안내</h4>
					</div>
					<div class="modal-body">
						외부 인원 및 업체가 참석하는 회의를 등록하는 메뉴입니다.<br>
						<span style="color:red;">회사 내부 인원</span>만 회의에 참석하는 경우 회의 관리 메뉴에서 등록하시기 바랍니다.
					</div>
