	...
	<head>
		...
		<script type="text/javascript">
			...
			function modifyVisitor(){
				var seq = $("#seq").val();
				var url = "/visitor/visitorModify.do?meetingSeq=" + seq;
			...
			function deleteVisitor(){
				...
				if(confirm("삭제 하시겠습니까?")){
					...
					var request = $.ajax({
						url: '/visitor/visitorDeleteAjax.json'
						, type : 'POST'
						, timeout: 30000
						, data : params
						, dataType : 'json'
						...
						, success : function(json) {
							if (json.resultCode == 1){
								alert("삭제 완료 되었습니다.");
								var url = "/visitor/visitorList.do";
								var queStr = $("#queStr").val();
								if(queStr != ""){
									url += "?" + queStr;
								}
			...
			function addResult(){
				var seq = $("#seq").val();
				var url = "/visitor/visitorResultAdd.do?meetingSeq=" + seq;
				var queStr = $("#queStr").val();
				if(queStr != ""){
					url += "&queStr="+encodeURIComponent(queStr);
				}
			...
			function modifyResult(){
				var seq = $("#seq").val();
				var url = "/visitor/visitorResultModify.do?meetingSeq=" + seq;
				var queStr = $("#queStr").val();
				if(queStr != ""){
					url += "&queStr="+encodeURIComponent(queStr);
				}
			...
			function deleteResult(){
				...
				if(confirm("삭제 하시겠습니까?")){
					...
					var request = $.ajax({
						url: '/visitor/visitorResultDeleteAjax.json'
						, type : 'POST'
						, timeout: 30000
						, data : params
						, dataType : 'json'
			...
			function confirmResult(meetingStatus){
				...
				if(confirm(alertText + " 하시겠습니까?")){
					...
					var request = $.ajax({
						url: '/visitor/visitorResultConfirmAjax.json'
						, type : 'POST'
						, timeout: 30000
						, data : params
						, dataType : 'json'
			...
			function downloadExcel() {
				...
				form.id = "downForm";
				form.method = "POST";
				form.action = "/visitor/visitorExcelDownload.do";
				...
				<section class="wrapper">
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-file-text-o"></i> 방문자 상세
							</h3>
							<ol class="breadcrumb">
					...
					<div class="btn-row text-right">
						...
						<c:if test="${isMine && (info.meetingStatus == '01' || info.meetingStatus == '02' || info.meetingStatus == '05') }">
							<a class="btn btn-default" href="javascript:;" title="수정하기" style="margin-top: 7px;" onClick="javascript:modifyVisitor();"><span class="icon_pencil-edit"></span>&nbsp;수정</a>
							<a class="btn btn-default" href="javascript:;" title="삭제하기" style="margin-top: 7px;" onClick="javascript:deleteVisitor();"><span class="icon_trash"></span>&nbsp;삭제</a>
						</c:if>
							...
							<div class="col-lg-12">
								<section class="panel" style="margin-bottom: 5px;">
									...
									<div class="panel-body">
										<form class="form-horizontal">
											<div class="form-group">
												<label class="col-lg-2 control-label">방문내용</label>
												<div class="col-lg-10">
											...
											<tbody>
												...
												<tr style="height: 130px;">
													...
													<td style="vertical-align: middle!important;">
														<c:if test="${info.sactionDate != '' && info.sactionDate != null }">
												...
												<tr>
													<c:choose>
														...
														<c:otherwise>
															<th>코멘트</th>
															<td>
																<c:if test="${ info.sactionComment != '' && info.sactionComment != null }">
																	${info.sactionComment }
																</c:if>
