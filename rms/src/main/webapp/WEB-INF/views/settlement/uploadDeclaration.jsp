		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$("#drop-area").dmUploader({
					url : '/settlement/declarationUploadAjax.json',
					dataType : "json",
					extFilter: ["pdf"],
			...
			function goSearch() {
				...
				var request = $.ajax({
					url : "/settlement/getDeclarationListAjax.json",
					type : "POST",
					timeout : 10000,
					data : params,
					dataType : "json",
			...
			function goDownload(fileName) {
				...
				form.id = "downForm";
				form.method = "POST";
				form.action = "/settlement/declarationDownload.do";
			...
			function goDelete(fileName) {
				if (confirm("[" + fileName + "]\n정말로 삭제하시겠습니까?")) {
					...
					var request = $.ajax({
						url : "/settlement/declarationDeleteAjax.json",
						type : "POST",
						timeout : 10000,
						data : params,
						dataType : "json",
			...
			<section id="main-content">
				...
				<section class="wrapper">
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-upload"></i> 공제신고서 업로드
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>관리 시스템</li>
								<li><i class="fa fa-krw"></i>연말정산 관리</li>
								<li><i class="fa fa-upload"></i>공제신고서 업로드</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
					...
					<div class="row">
						<div class="col-lg-12">
							<section class="panel">
								<header class="panel-heading">공제신고서 파일 조회</header>
					...
					<div class="row" id="uploadDiv" style="display:none;">
						<div class="col-lg-3">
							<section class="panel">
								<header class="panel-heading">공제신고서 파일 선택</header>
						...
						<div class="col-lg-9">
							<section class="panel">
								<header class="panel-heading">공제신고서 업로드 결과</header>
