	...
	<head>
		...
		<script type="text/javascript">
			...
			function goDBSearch() {
				...
				var request = $.ajax({
					url : "/settlement/getDeclarationDBListAjax.json",
					type : "POST",
					timeout : 10000,
					data : params,
					dataType : "json",
			...
			function goAnalyze(idx, fileName) {
				...
				var request = $.ajax({
					url : "/settlement/analyzeDeclarationAjax.json",
					type : "POST",
					timeout : 10000,
					data : params,
					dataType : "json",
			...
			<section id="main-content">
				...
				<section class="wrapper">
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-database"></i> 공제신고서 분석
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>관리 시스템</li>
								<li><i class="fa fa-krw"></i>연말정산 관리</li>
								<li><i class="fa fa-database"></i>공제신고서 분석</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
					...
					<div class="row">
						<div class="col-lg-12">
							<section class="panel">
								<header class="panel-heading">공제신고서 파일/DB 조회</header>
