		...
		<script type="text/javascript">
			...
			function goConfirm() {
				...
				if (confirm("등록하시겠습니까?")) {
					...
					var request = $.ajax({
						url: '/realestate/realestateAddAjax.json'
						, type : 'POST'
						, timeout: 0
						, data : formData
						, processData : false
						...
						, success : function(json) {
							if (json.resultCode == 1){
								alert("저장 완료 되었습니다.");
								location.href="/realestate/realestateList.do";
							}else if (json.resultCode == 1201) {
								alert(json.resultMsg);
								cfLogin();
							}else{
				...
				var params = {
					...
					$.ajax({
						...
						,success:function(jsonStr){
							...
							// 해당좌표로 지도 이동 및 마커 생성
							apiMap.initAll();
						    var marker = new vworld.Marker(positionX, positionY, "도로명 주소 : " + data.roadAddr + "<br>지번 주소 : " + data.jibunAddr, "");
						    marker.setZindex(3);
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header">
								<i class="fa fa-pencil"></i> 부동산 계약 등록
							</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-laptop"></i>관리 시스템</li>
								<li><i class="fa fa-building-o"></i>부동산 계약 관리</li>
								<li><i class="fa fa-pencil"></i>부동산 계약 등록</li>
							</ol>
						</div>
					</div>
					<!-- title end -->
