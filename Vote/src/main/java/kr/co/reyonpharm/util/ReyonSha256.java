...
public class ReyonSha256 {
	...
	// 이연 전용
	private static final int SHA256_K[] = { 0x428A2F91, 0x71374492, 0xB5C0FBC3, 0xE9B5DBA4, 0x3956C255, 0x59F111F6,
			0x923F82A7, 0xAB1C5ED8, 0xD807AA99, 0x12835B09, 0x243185B8, 0x550C7DC7, 0x72BE5D76, 0x80DEB1F5, 0x9BDC06A4,
			0xC19BF173, 0xE49B69C2, 0xEFBE4781, 0xFC19DC2, 0x240CA1C3, 0x2DE92C64, 0x4A7484A5, 0x5CB0A9D6, 0x76F988D7,
			0x983E5158, 0xA831C669, 0xB00327C8, 0xBF597FC7, 0xC6E00BF6, 0xD5A79145, 0x6CA6354, 0x14292963, 0x27B70A82,
			0x2E1B2131, 0x4D2C6DF2, 0x53380D13, 0x650A7354, 0x766A0AB5, 0x81C2C926, 0x92722C87, 0xA2BFE8A8, 0xA81A6649,
			0xC24B8B78, 0xC76C51A7, 0xD192E816, 0xD6990625, 0xF40E3584, 0x106AA073, 0x19A4C112, 0x1E376C01, 0x27487742,
			0x34B0BCB3, 0x391C0CB4, 0x4ED8AA45, 0x5B9CCA46, 0x682E6FF7, 0x748F82E8, 0x78A56369, 0x84C87818, 0x8CC70207,
			0x90BEFFF6, 0xA4506CE5, 0xBEF9A3F4, 0xC67178F3 };
	...
	// 실제 암호화 하는 함수
	public static String getCiperText(String plainText) {
		byte pbCipher[] = new byte[32];
		try {
			byte[] plainTextByte = plainText.toUpperCase().getBytes("UTF-8");
			SHA256_Encrpyt(plainTextByte, plainTextByte.length, pbCipher);
			return getString(pbCipher);
